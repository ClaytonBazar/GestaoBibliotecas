...
//cadastrar livros   
    ...
    public void cadastrarLivros(Livros l) {
        ...
        try {
            ...
            pstm.setString(5, l.getQuantEstoque());
    ...
    public ArrayList<Livros> ListarLivros() {
        ...
        try {
            ...
            while (rs.next()) {
                ...
                l4.setQuantEstoque(rs.getString("quantEstoque"));
...
// deletar livros
    public void deleteLivros(Livros bi) {
        ...
        try {
            ...
            pstm.setString(5, p.getQuantEstoque());
    ...
    public ArrayList<Livros> ListarLivrosDis() {
        ...
        try {
            ...
            while (rs.next()) {
                ...
                l1.setQuantEstoque(rs.getString("quantEstoque"));
...
// Filtros de pesquisa de dados
    ...
    public Livros PesquisarLivrosT(String titulo) {
        ...
        try {
            ...
            l.setQuantEstoque(rs.getString("quantEstoque"));
